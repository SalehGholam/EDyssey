...
# =============================================================================
    ...
    def convert_datasets(self):
        ...
        self._tic_convert = perf_counter()
        self.logger.info('Starting tpx3 conversion for %d file(s) (%d process(es))...',
                          len(args), no_processes)
        self.pool.map_async(self.process_file, args,
                             callback=self._on_convert_success,
