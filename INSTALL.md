...
bundled in this repo under `py4DTomo/io_utils/` - nothing to install
...
loading (the eventem-based fast paths in `py4DTomo/io_utils/loaders.py` and
...
The clip-export functions (`py4DTomo/io_utils/video.py`) pipe frames to
...
Run `5DED_MainWidow.py`. See [MANUAL.md](MANUAL.md) for usage.
